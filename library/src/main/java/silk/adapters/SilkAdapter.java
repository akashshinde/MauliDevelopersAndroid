...
public abstract class SilkAdapter<ItemType extends SilkComparable> extends BaseAdapter implements ScrollStatePersister {
    ...
    /**
     * @deprecated Override {@link #onViewCreated(int, android.view.View, silk.SilkComparable)} instead.
     */
    @Override
    ...
    /**
     * Gets the scroll state set by a {@link silk.views.list.SilkListView}.
     */
    @Override
    ...
    /**
     * Used by the {@link silk.views.list.SilkListView} to update the adapter with its scroll state.
     */
    @Override
